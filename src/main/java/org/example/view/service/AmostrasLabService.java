...
import org.example.controller.repository.AmostrasLabRepository;
...
public class AmostrasLabService {
    ...
    public void cadastrarExame(Scanner sc) {
        ...
        org.example.service.PacienteService pacienteService = new org.example.service.PacienteService();
...
//        novaAmostra.setResultado(resultado);
        ...
        try {
            ...
            LocalDateTime dataConsulta = consulta.getLocalDateTime(); // Supondo que seja LocalDateTime
